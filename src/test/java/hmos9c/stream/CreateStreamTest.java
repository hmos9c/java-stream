...
public class CreateStreamTest {
  ...
  void testCreateEmptyOrSingleStream() {
    ...
    Stream<String> oneStream = Stream.of("Sanas");
    oneStream.forEach(data -> {
      System.out.println(data);
    });

    String data = "Febriyan";
  ...
  void testCreateStreamFromArray() {
    Stream<String> arrayStream = Stream.of("Sanas", "Febriyan", "hmos9c");
  ...
  void testCreateStreamFromCollection() {
    Collection<String> collection = List.of("Sanas", "Febriyan", "hmos9c");
  ...
  void testCreateInfiniteStream() {
    Stream<String> stream = Stream.generate(() -> "hmos9c");
